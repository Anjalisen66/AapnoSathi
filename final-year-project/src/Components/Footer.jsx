    ...
    >
      ...
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center space-y-8 md:space-y-0">
        <div className="max-w-200">
          <img src={logo} alt="logo" className="mb-4 h-28 md:h-32 w-auto ml-10" />
          <p
            className="text-md font-medium ml-6"
            style={{ fontFamily: "Garamond, serif", position: "relative" }}
          >
      ...
      <div className="flex flex-col md:flex-row gap-2 items-center justify-center  pb-0 font-medium">
